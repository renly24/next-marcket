...
const ImgInput = (props) => {
    ...
    const handleClick = async() => {
        ...
        try{
            ...
            data.append("upload_preset", "test-preset")
            data.append("cloud_name","diwbeceqt")
            const response= await fetch("https://api.cloudinary.com/v1_1/diwbeceqt/image/upload", {method: "POST", body: data})
